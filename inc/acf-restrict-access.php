 ...
 */
add_filter( 'acf/settings/show_admin', 'dcp_show_acf_admin' );
/**
 * Filters the settings to pass to the block editor for all editor type.
 *
 * @link https://developer.wordpress.org/reference/hooks/block_editor_settings_all/
 */
add_filter( 'block_editor_settings_all', 'dcp_restrict_locking_ui', 10, 2 );
 ...
 * @since 0.1.3
 */
function dcp_restrict_locking_ui( $settings ) {
	$settings['canLockBlocks'] = dcp_show_acf_admin();
