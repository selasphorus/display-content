...
add_image_size( 'grid_crop_rectangle', 534, 300, true ); // Aspect Ratio: approx 16:9 -- deprecated in favor of 'grid_crop_landscape'
...
function birdhive_get_posts ( $args = array() ) {
    ...
    $defaults = array(
        ...
        //
        'context'    => 'general', // optional -- e.g. "snippet" -- WIP 06/04/25
        'do_ts'                => false,
    );

    // Parse & Extract args
    // TODO: rethink this -- RS/consider risks of extract -- maybe better to control this more explicitly?
    $args = wp_parse_args( $args, $defaults );
    extract( $args );
